...
> **Por confirmar:** la tarifa real de Bold. El ingreso neto de $22.000 por transacción asume 3% de
> pasarela. Si difiere, ese número y el punto de equilibrio se mueven.
...
| Métrica | Valor |
|---|---|
| Ticket promedio | $100.000 COP |
| Ingreso neto Pawwi por transacción | $22.000 COP |
...
**El punto de equilibrio no es 68.**
68 × $22.000 = $1.496.000, que cubre los fijos pero **deja fuera los $400.000 de marketing**. Con
marketing son **86 transacciones/mes**, un 26% más alto.
...
gasta el cliente**, no lo que gana Pawwi. Con el 25%, el LTV real es $75.000:

| Canal | CAC | LTV real | Ratio | Veredicto |
|---|---|---|---|---|
| Pauta (Lead Ads) | $80.000 | $75.000 | **0,94×** | ❌ Pierde plata |
| Referido | $20.000 | $75.000 | 3,75× | ✅ Viable |
| Grupos de WhatsApp | $0 | $75.000 | ∞ | ✅ Viable |
