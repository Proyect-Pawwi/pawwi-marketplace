    ...
    <div className="min-h-screen bg-[#FFF1EB] text-[#120A2B]">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-[#6B7280] font-medium leading-relaxed text-pretty">
          Estamos finalizando la versión completa de nuestros Términos y Condiciones.
          Mientras tanto, si tienes preguntas sobre el uso de Pawwi, las reservas, los
          pagos o las responsabilidades de cuidadores y dueños, escríbenos y con gusto te
          ayudamos.
        </p>
