...
import RegistroPawwerForm from "./RegistroPawwerForm";

export const metadata: Metadata = {
  title: "Crear cuenta Pawwer — Pawwi",
  description: "Regístrate como Pawwer y empieza a recibir reservas en Bogotá.",
};

export default function RegistroPawwerPage() {
  return (
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 font-body text-sm">
            Cuida perros, pon tus horarios y gana dinero.
          </p>
        </div>
        ...
        <div className="text-center mt-6">
          ...
          >
            ¿Buscas cuidador? Explorar Pawwers
          </Link>
        </div>
      </div>
    </main>
